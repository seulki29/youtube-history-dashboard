...
const CATEGORIES = [
  ...
  { cat: '키즈·게임',   owner: '자인', kw: ['mrbeast', '키즈', 'kids', '마인크래프트', 'minecraft', '로블록스', 'roblox'] },
  ...
  { cat: '영화·리뷰',   owner: '아빠', kw: ['영화', 'movie', '리뷰', '결말', '무비', '빨강도깨비'] },
  { cat: '축구·스포츠', owner: '아빠', kw: ['축구', 'soccer', 'football', 'tottenham', 'man city', 'premier league', '손흥민', '스포츠', 'sports', '야구', '농구', '슛포러브', '아트사커'] },
